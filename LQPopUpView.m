...
-(instancetype)initWithTitleConfiguration:(void (^)(TitleConfiguration *))titleConfiguration messageConfiguration:(void (^)(MessageConfiguration *))msgConfiguration {
    self = [self init];
    if (self) {
        ...
        if (msgConfiguration) {
            ...
            if (!_msg_configuration.text || _title_Configuration.text.length) _msg_configuration = nil;
        }else {
...
#pragma mark - /---------------------- public ----------------------/
-(instancetype)initAlertWithTitleConfiguration:(void (^)(TitleConfiguration *))titleConfiguration
                          messageConfiguration:(void (^)(MessageConfiguration *))msgConfiguration {
    return [[LQPopUpView alloc] initWithTitleConfiguration:titleConfiguration messageConfiguration:msgConfiguration];
}

-(instancetype)initActionSheetWithTitleConfiguration:(void (^)(TitleConfiguration *))titleConfiguration
                                messageConfiguration:(void (^)(MessageConfiguration *))msgConfiguration {
    return [[LQPopUpView alloc] initAlertWithTitleConfiguration:titleConfiguration messageConfiguration:msgConfiguration];
}
